...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] bg-[#F8F9FA] overflow-hidden pt-32 pb-24 lg:pt-40 lg:pb-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10 w-full h-full flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start gap-8 mt-10">
            ...
            {/* Decorative Dots */}
            <div className={`flex items-center gap-2 transition-all duration-700 delay-100 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            <p className={`text-[17px] md:text-[19px] text-gray-700 max-w-md font-medium leading-[1.6] transition-all duration-700 delay-200 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            <div className={`transition-all duration-700 delay-300 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
               <button className="bg-[#21C57D] text-black text-[17px] font-bold px-8 py-3 rounded-full border-[1.5px] border-black shadow-[3px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[1px] hover:shadow-[2px_3px_0px_0px_rgba(0,0,0,1)] active:translate-y-[3px] active:shadow-none transition-all">
                 {HERO_CONTENT.primaryCTA}
               </button>
            </div>

            {/* Bottom Left Stats */}
            <div className={`mt-12 flex items-center gap-12 transition-all duration-700 delay-400 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              <div>
          ...
          <div className={`relative w-full h-[600px] lg:h-[750px] transition-all duration-700 delay-500 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            {/* Floating Elements */}
            <div className="absolute right-0 lg:right-[-2%] top-[18%] flex flex-col gap-3 z-20 items-end">
              <div className="bg-[#FFD147] px-5 py-2.5 rounded-full border-[1.5px] border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] text-black font-bold text-[14px] whitespace-nowrap">
                Assessment Design
              </div>
              <div className="bg-white px-5 py-2.5 rounded-full border-[1.5px] border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] text-black font-semibold text-[14px] whitespace-nowrap">
            ...
            {/* Floating Card */}
            <div className="absolute right-[-10%] lg:right-[-8%] bottom-[22%] bg-white p-4 rounded-xl border-[1.5px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-20 flex gap-4 items-start max-w-[260px]">
        ...
        <div className={`mt-16 flex flex-col md:flex-row items-center gap-12 max-w-[1000px] transition-all duration-700 delay-600 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          {/* Video / Image Card */}
